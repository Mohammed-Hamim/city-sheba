...
const Footer = () => {
    return (
        <footer className="bg-green-200/60 mt-16 border-t border-gray-200">
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <div className="flex gap-4 text-gray-700">
                        <a className="bg-white p-3 rounded-full shadow text-blue-700 hover:bg-gray-200">
                            <FaFacebookF />
                        </a>
                        <a className="bg-white p-3 rounded-full shadow text-red-600 hover:bg-gray-200">
                            <FaInstagram />
                        </a>
